...
ALLOWED_HOSTS = [
    'ebrads-course-env.eba-pepcery4.us-west-2.elasticbeanstalk.com', "*"]
...
WSGI_APPLICATION = 'ebrads.wsgi.application'
...
if 'RDS_DB_NAME' in os.environ:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': "xwoqxdrs",  # User & Default database
            "USER": "xwoqxdrs",  # User & Default database
            "PASSWORD": "",
...
DEFAULT_FILE_STORAGE = 'ebrads.media_storages.MediaStorage'
'''
